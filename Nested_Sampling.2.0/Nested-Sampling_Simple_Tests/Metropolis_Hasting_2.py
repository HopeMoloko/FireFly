...
def Metropolis_Hasting_NS(logLikelihood_func,args_loglikelihood,Prior_func,args_prior,theta,stepsize,mcmc_steps,\
                       loglikelihood_theta,prior_theta,logspace=True):
    ...
    for mcmci in range(mcmc_steps):
        ...
        if logspace == True: # Yes work in logspace
            ...
            likelihood_new = logLikelihood
            likelihood_theta = logLikelihood_theta
